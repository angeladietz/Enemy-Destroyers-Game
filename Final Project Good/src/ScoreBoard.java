...
public class ScoreBoard {
	...
	private void initialize() {
		scrs = new Scores(pScore, pName); //initializes scoring object
		...
		frmEnemyDestroyersHigh.setContentPane(new JLabel(new ImageIcon("space.png")));
		...
		lblHighscores.setForeground(new Color(224, 255, 255));
		...
		lblPScore.setForeground(new Color(224, 255, 255));
		...
		txtPScore.setForeground(new Color(224, 255, 255));
		txtPScore.setVerticalAlignment(SwingConstants.TOP);
		txtPScore.setBounds(247, 56, 200, 146);
		/**
